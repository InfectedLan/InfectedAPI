...
class NoteHandler {
	 ...
	 * Create a new note.
	 */
	public static function createNote(User $creatorUser, ?Group $group, ?Team $team, ?User $user, string $title, string $content, int $secondsOffset, string $time = null): Note {
		$database = Database::getConnection(Settings::db_name_infected_crew);
	 ...
	 * Update a note.
	 */
	public static function updateNote(Note $note, ?Group $group, ?Team $team, ?User $user, string $title, string $content, int $secondsOffset, string $time = null) {
		$database = Database::getConnection(Settings::db_name_infected_crew);
