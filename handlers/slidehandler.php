...
class SlideHandler {
	public static function getSlide($id) {
		...
		$result = mysqli_query($con, 'SELECT * FROM ' . Settings::db_table_infected_main_slides . ' WHERE id=\'' . $id . '\'');
	...
	public static function getSlides() {
		...
		$result = mysqli_query($con, 'SELECT id FROM ' . Settings::db_table_infected_main_slides . ' ORDER BY start');
		$slideList = array();
