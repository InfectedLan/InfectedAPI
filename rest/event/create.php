...
if (Session::isAuthenticated()) {
	...
	if ($user->hasPermission('admin.event')) {
		if (isset($_POST['locationId']) &&
			...
			if ($location != null) {
				EventHandler::createEvent($location, $participantCount, $bookingTime, $prioritySeatingTime, $seatingTime, $startTime, $endTime);
				$result = true;
				$status = 201; // Created.
			} else {
                $status = 404; // Not found.
                $message = Localization::getLocale('this_location_does_not_exist');
            }
		} else {
